...
RELEASE_DIR="skulls-x230_fhd-${version}"
rm -rf "$RELEASE_DIR"
mkdir -p "$RELEASE_DIR"
...
git commit -a -m "release skulls-x230_fhd ${version}"
git tag -s "x230_fhd-${version}" -m "skulls-x230_fhd ${version}"
